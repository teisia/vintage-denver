exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('stores').insert({name: 'Babereeba', street1: '3629 West 32nd Avenue', street2: '', city: 'Denver', state: 'CO', zip: 80211, rating: 3, bio: 'This quaint consignment shop sells high-end used & vintage clothing, plus fashion accessories.', image: 'images/babareeba.jpg', site: 'http://www.yelp.com/biz/babareeba-denver', neighborhood_id: 3})
  );
};
